...
copyAndFreeze bs f =
    trace "Data.ByteArray copyAndFreeze" $ inlineUnsafeCreate (length bs) $ \d -> do
        trace "Data.ByteArray copyAndFreeze - calling copyByteArrayToPtr" $ copyByteArrayToPtr bs d
        f (castPtr d)
